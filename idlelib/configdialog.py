...
class ConfigDialog(Toplevel):
    ...
    def create_widgets(self):
        ...
        note.add(self.fontpage, text=' 字体/标签 ')
        note.add(self.highpage, text=' 高亮 ')
        note.add(self.keyspage, text=' 键盘 ')
        note.add(self.genpage, text=' 常规 ')
...
class FontPage(Frame):
    ...
    def create_page_font_tab(self):
        ...
        frame_font = LabelFrame(
                self, borderwidth=2, relief=GROOVE, text=' Shell/编辑器 字体 ')
        frame_sample = LabelFrame(
                self, borderwidth=2, relief=GROOVE,
                text=' 字体示例（可编辑） ')
        frame_indent = LabelFrame(
                self, borderwidth=2, relief=GROOVE, text=' 缩进长度 ')
        # frame_font.
...
class HighPage(Frame):
    ...
    def create_page_highlight(self):
        ...
        self.button_set_color = Button(
                self.frame_color_set, text='选择颜色为 :',
...
class KeysPage(Frame):
    ...
    def create_page_keys(self):
        ...
        frame_custom = LabelFrame(
                ...
                text=' 自定义键盘绑定 ')
        frame_key_sets = LabelFrame(
                self, borderwidth=2, relief=GROOVE, text=' 键盘设置 ')
        # frame_custom.
        frame_target = Frame(frame_custom)
        target_title = Label(frame_target, text='快捷键')
        ...
        self.builtin_keyset_on = Radiobutton(
                ...
                command=self.set_keys_type, text='使用内置键盘设置')
        self.custom_keyset_on = Radiobutton(
                frames[0], variable=self.keyset_source, value=0,
                command=self.set_keys_type, text='使用自定义键盘设置')
        self.builtinlist = DynOptionMenu(
...
class GenPage(Frame):
    ...
    def create_page_general(self):
        ...
        startup_title = Label(frame_run, text='启动')
        ...
        self.button_helplist_add = Button(
                frame_helplist_buttons, text='增加',
    ...
    def helplist_item_add(self):
        ...
        them to the list.
        """
        help_source = HelpSource(self, '新帮助来源').result
        if help_source:
