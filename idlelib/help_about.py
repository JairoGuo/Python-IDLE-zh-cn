...
class AboutDialog(Toplevel):
    ...
    def create_widgets(self):
        ...
        self.py_credits = Button(py_buttons, text='信任', width=8,
                                 highlightbackground=self.bg,
        ...
        self.readme = Button(idle_buttons, text='自述', width=8,
                             highlightbackground=self.bg,
                             command=self.show_readme)
        self.readme.pack(side=LEFT, padx=10, pady=10)
        self.idle_news = Button(idle_buttons, text='新闻', width=8,
                                highlightbackground=self.bg,
                                command=self.show_idle_news)
        self.idle_news.pack(side=LEFT, padx=10, pady=10)
        self.idle_credits = Button(idle_buttons, text='信任', width=8,
                                   highlightbackground=self.bg,
